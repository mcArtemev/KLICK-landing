        ...
        <div class="shell">
            ...
            <div class="tangle-board">
                ...
                <div class="yarn-ball" aria-label="Klick связывает инструменты">
                    <img src="/yarn-ball.png" alt="" aria-hidden="true">
                    <span>Klick</span>
                </div>
...
<style scoped>
    ...
    .yarn-ball{position:absolute;z-index:2;top:24%;left:37%;width:270px;height:270px;transform:rotate(-3deg);filter:drop-shadow(10px 11px 0 rgb(33 28 26/.92));pointer-events:none}.yarn-ball img{width:100%;height:100%;display:block;object-fit:contain}.yarn-ball span{position:absolute;top:38%;left:54%;color:#fffdf7;font:700 44px Caveat,cursive;text-shadow:2px 2px 0 var(--workshop-ink);transform:translate(-50%,-50%) rotate(3deg)}
