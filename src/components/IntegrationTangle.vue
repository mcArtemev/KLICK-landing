...
<style scoped>
    ...
    .tool-note{position:absolute;z-index:3;width:160px;display:flex;gap:11px;align-items:center;padding:13px 8px 13px 13px;text-align:left;color:var(--workshop-ink);border:2px solid var(--workshop-ink);border-radius:9px 15px 8px 13px;background:#fffdf7;box-shadow:4px 4px 0 var(--workshop-ink);cursor:pointer;transition:background-color .18s,box-shadow .18s}.tool-note:hover,.tool-note.active{box-shadow:2px 2px 0 var(--workshop-ink);background:#ffd84d}.tool-note>span{display:flex;min-width:0;flex-direction:column}.tool-note b{font-size:13px}.tool-note small{overflow:hidden;color:#716963;font-size:10px;text-overflow:ellipsis;white-space:nowrap}.tool-note--calendar{top:16.3%;left:12%;transform:translate(-50%,-100%) rotate(-2deg)}.tool-note--video{top:14%;left:88.8%;transform:translate(-50%,-100%) rotate(2deg)}.tool-note--files{top:79.6%;left:9.6%;transform:translate(-50%) rotate(1deg)}.tool-note--chat{top:80.4%;left:91%;transform:translate(-50%) rotate(-2deg)}.tool-note--notes{top:7%;left:30.6%;transform:translateY(-50%) rotate(1deg)}.tool-note--pay{top:93.7%;left:61.4%;transform:translate(-50%,-50%) rotate(-1deg)}
    ...
    @media(max-width:620px){.tangle-board{height:1000px}.tool-note{width:145px}.tool-note--calendar{top:12%;left:3%}.tool-note--video{top:12%;right:3%}.tool-note--files{left:3%}.tool-note--chat{right:3%}.tool-note--notes{top:4%;left:29%}.tool-note--pay{left:28%}.yarn-ball{top:43%;width:245px;height:245px}.tangle-result{top:56%;right:8%;width:84%}.tangle-summary{font-size:19px}.tangle-summary i{width:25px}}
</style>
