...
<style scoped>
    ...
    .tangle-heading{display:grid;grid-template-columns:1.1fr .8fr;gap:9vw;align-items:end;margin-bottom:48px}.tangle-heading h2{margin:22px 0 0;font-size:clamp(2.625rem,5vw,4.75rem);line-height:.96;letter-spacing:-.06em}.tangle-heading p{position:relative;margin:0;padding:20px 22px;color:rgb(33 28 26/.76);border:2px solid var(--workshop-ink);border-radius:14px 19px 13px 17px;background:rgb(255 253 247/.82);box-shadow:5px 6px 0 var(--workshop-ink);font-size:0.9375rem;line-height:1.65}.tangle-heading p::before{position:absolute;top:-8px;left:26px;width:13px;height:13px;border:2px solid var(--workshop-ink);border-radius:50%;background:var(--workshop-green);content:''}
    ...
    .tool-note{position:absolute;z-index:3;width:160px;display:flex;gap:.85em;align-items:center;padding:1em .62em 1em 1em;text-align:left;color:var(--workshop-ink);border:2px solid var(--workshop-ink);border-radius:9px 15px 8px 13px;background:#fffdf7;box-shadow:4px 4px 0 var(--workshop-ink);cursor:pointer;font-size:.8125rem;transition:background-color .18s,box-shadow .18s}.tool-note:hover,.tool-note.active{box-shadow:2px 2px 0 var(--workshop-ink);background:#ffd84d}.tool-note>span{display:flex;min-width:0;flex-direction:column}.tool-note b{font-size:1em}.tool-note small{overflow:hidden;color:#716963;font-size:.77em;text-overflow:ellipsis;white-space:nowrap}.tool-note--calendar{top:16.3%;left:12%;transform:translate(-50%,-100%) rotate(-2deg)}.tool-note--video{top:14%;left:88.8%;transform:translate(-50%,-100%) rotate(2deg)}.tool-note--files{top:79.6%;left:9.6%;transform:translate(-50%) rotate(1deg)}.tool-note--chat{top:80.4%;left:91%;transform:translate(-50%) rotate(-2deg)}.tool-note--notes{top:7%;left:30.6%;transform:translateY(-50%) rotate(1deg)}.tool-note--pay{top:93.7%;left:61.4%;transform:translate(-50%,-50%) rotate(-1deg)}
    .yarn-ball{position:absolute;z-index:2;top:50%;left:50%;width:270px;height:270px;transform:translate(-50%,-50%) rotate(-3deg);filter:drop-shadow(10px 11px 0 rgb(33 28 26/.92));pointer-events:none}.yarn-ball img{width:100%;height:100%;display:block;object-fit:contain}.yarn-ball__label{position:absolute;top:50%;left:50%;display:flex;min-width:110px;align-items:center;flex-direction:column;padding:8px 17px 10px;color:var(--workshop-ink);border:2px solid var(--workshop-ink);border-radius:48% 52% 45% 55%;background:#fff3a8;box-shadow:3px 4px 0 var(--workshop-ink);font-family:Caveat,cursive;line-height:.82;transform:translate(-50%,-50%) rotate(3deg)}.yarn-ball__label small{font-size:1.0625rem;font-weight:600}.yarn-ball__label b{font-size:1.6875rem;font-weight:700}
    .tangle-result{position:absolute;z-index:4;top:29%;right:4%;width:290px;padding:22px;border:2px solid var(--workshop-ink);border-radius:18px 10px 20px 12px;background:#fffdf7;box-shadow:6px 7px 0 var(--workshop-lilac)}.tangle-result small{text-transform:uppercase;letter-spacing:.08em;color:#7c6f65;font-size:0.5625rem;font-weight:800}.tangle-result h3{margin:9px 0;font-size:1.3125rem}.tangle-result p{margin:0;color:#655d57;font-size:0.75rem;line-height:1.55}.tangle-result strong{display:block;margin-top:14px;color:#6752c8;font:700 1.125rem/1.1 Caveat,cursive}
