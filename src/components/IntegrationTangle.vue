...
<script setup lang="ts">
    ...
    const tools = [
        ...
        { id : 'chat', title : 'Переписка', service : 'общего мессенджера', heading : 'Сообщения помнят, о чём речь', text : 'Комментарии к работе и договорённости не теряются среди других диалогов.', result : 'Меньше повторных вопросов и объяснений', icon : MessageCircleMore, path : 'M540 278C586 302 614 350 664 339C716 328 748 383 802 386C846 389 872 426 910 434' },
        ...
        { id : 'pay', title : 'Оплаты', service : 'таблиц и ручного учёта', heading : 'Финансы продолжают расписание', text : 'Пакеты, списания, оплаты и отмены образуют понятную историю операций.', result : 'Баланс ученика всегда актуален', icon : WalletCards, path : 'M522 291C552 325 532 356 565 387C594 415 575 451 602 473C614 483 610 497 614 506' }
    ] as const;
