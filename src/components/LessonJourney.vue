...
<script setup lang="ts">
    ...
    const steps=[
        ...
        {title:'Материалы',short:'уже рядом',heading:'Нужные файлы открываются из урока',text:'Материалы остаются связаны с темой и доступны ученику после занятия.',result:'не нужно искать папку',uiTitle:'Материалы урока',rows:['Present Perfect.pdf','Практика.docx','Снимок доски.png'],icon:FileText},
