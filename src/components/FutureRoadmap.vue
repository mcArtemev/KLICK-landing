...
<style scoped>
    .future-section{overflow:hidden;background-color:#dff2ff;background-image:linear-gradient(rgb(33 28 26/.07) 1px,transparent 1px);background-size:100% 30px;border-bottom:2px solid var(--workshop-ink)}.future-heading{display:grid;grid-template-columns:1.1fr .8fr;gap:8vw;align-items:end;margin-bottom:50px}.future-heading h2{margin:22px 0 0;font-size:clamp(2.6875rem,5vw,4.625rem);line-height:.97;letter-spacing:-.06em}.future-heading p{color:rgb(33 28 26/.7);font-size:1.0625rem;line-height:1.7}.future-map{position:relative;display:grid;grid-template-columns:.8fr 1.2fr;gap:34px}.future-thread{position:absolute;top:-20px;bottom:-20px;left:31%;border-left:4px dashed #6752c8}.future-tabs{z-index:2;display:flex;flex-direction:column;gap:10px}.future-tabs button{display:grid;grid-template-columns:32px 26px 1fr;gap:10px;align-items:center;padding:14px;text-align:left;color:var(--workshop-ink);border:2px solid var(--workshop-ink);border-radius:13px 19px 12px 17px;background:#fffdf7;box-shadow:4px 4px 0 var(--workshop-ink);cursor:pointer}.future-tabs button.active{background:var(--workshop-lilac);transform:translateX(7px);box-shadow:7px 6px 0 var(--workshop-ink)}.future-tabs button>i{font:700 1.0625rem Caveat,cursive;font-style:normal}.future-tabs button span{display:flex;flex-direction:column;gap:3px}.future-tabs b{font-size:0.75rem}.future-tabs small{font-size:0.5rem;letter-spacing:.08em}.future-card-slot{display:grid;min-height:455px;align-items:start}.future-card{position:relative;min-height:425px;padding:58px;border:2px solid var(--workshop-ink);border-radius:30px 18px 28px 16px;background:#fffdf7;box-shadow:11px 12px 0 var(--workshop-ink);transform:rotate(1deg)}.future-pin{position:absolute;top:18px;left:50%;width:16px;height:16px;border:2px solid var(--workshop-ink);border-radius:50%;background:var(--workshop-orange);box-shadow:0 5px 0 var(--workshop-ink)}.future-card>small{font-size:0.625rem;font-weight:800;letter-spacing:.13em}.future-card h3{max-width:650px;margin:18px 0;font-size:clamp(1.875rem,4vw,3.1875rem);line-height:1;letter-spacing:-.04em}.future-card p{max-width:650px;color:#655d57;font-size:0.9375rem;line-height:1.65}.future-card div{display:flex;flex-wrap:wrap;gap:8px;margin:25px 0}.future-card div i{padding:7px 10px;border:1px solid var(--workshop-ink);border-radius:99px;background:#fff3a8;font-size:0.5625rem;font-style:normal}.future-card strong{display:block;max-width:600px;color:#6752c8;font:700 1.5rem/1.15 Caveat,cursive}.future-disclaimer{margin:32px 0 0;color:#777069;font-size:0.6875rem;text-align:center}.future-card-enter-active,.future-card-leave-active{transition:.18s}.future-card-enter-from,.future-card-leave-to{opacity:0;transform:translateY(12px) rotate(1deg)}
